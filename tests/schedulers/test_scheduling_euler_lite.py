"""Contract test for EulerLiteScheduler.

Structural + signature layers run with no extra installs. Behavioral checks
skip without torch/diffusers, which is expected on a kit-only runner.
"""
import ast
